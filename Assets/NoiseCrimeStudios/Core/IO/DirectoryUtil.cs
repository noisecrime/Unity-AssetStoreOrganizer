...
namespace NoiseCrimeStudios.Core.IO
{
    ...
    public static partial class DirectoryUtils
	{
...
#else
        public enum SearchPattern { ANY, IMAGE, XML, QEP, UNITYPACKAGE, CUSTOM }
#endif
		...
		public static string GetSearchPattern( SearchPattern searchPattern )
		{
			...
			{
				case SearchPattern.Any:             return "*.*";
				case SearchPattern.ImageImportable: return "*.png|*.jpg|*.jpeg";
				case SearchPattern.ImageFormats:    return "*.png|*.jpg|*.jpeg|*.tiff|*.tif";
                case SearchPattern.Xml:             return "*.xml";
				case SearchPattern.QEP:             return "*.qet";
				case SearchPattern.UnityPackage:    return "*.unitypackage";
			}
...
#endif
		static void ValidateRelativeToAbsolutePathExamples()
		{
...
#endif
		static void ValidateGetListFromDirectory()
		{
			bool            truncate            = true;
		...
		static void FileListTest( string path, string multiSearchPattern, SearchOption searchOption, bool sorted, bool filenameOnly, bool truncate )
		{
		...
		static void PrintToConsole( string header, List<string> stringList, bool truncate = false )
		{
